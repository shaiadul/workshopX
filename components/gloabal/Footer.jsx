    ...
    <div className="bg-gray-800 py-4 text-gray-400">
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-teal-600">Blog</h2>
            </div>
            <ul className="leading-8">
              <li><a href="#" className="hover:text-teal-400">Getting Started With HTML and CSS</a></li>
              <li><a href="#" className="hover:text-teal-400">What Is Flex And When to Use It?</a></li>
              <li><a href="#" className="hover:text-teal-400">How TailwindCSS Can Help Your Productivity?</a></li>
              <li><a href="#" className="hover:text-teal-400">5 Tips to Make Responsive Website</a></li>
              <li><a href="#" className="hover:text-teal-400">See More</a></li>
            </ul>
          </div>
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-teal-600">Connect With Us</h2>
            </div>
            <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-teal-400 hover:border-teal-400">
            ...
            <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-teal-400 hover:border-teal-400">
      ...
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © {new Date().getFullYear()} Workshop
          </div>
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with ❤️ by Md Saidul Bashar.
          </div>
        </div>
      </div>
    </div>
